...
mod generic {
    ...
    pub(super) fn encode<C, T, W: Write>(
        _x: &T,
        _e: &mut Encoder<W>,
        _c: &mut C,
    ) -> Result<(), encode::Error<W::Error>> {
...
struct GS2<T, U> {
    #[n(0)]
    #[cbor(encode_with = "generic::encode")]
    field1: Gen<T>,
    #[n(1)]
    field2: U,
}
...
struct GS3<T, U> {
    #[n(0)]
    #[cbor(decode_with = "generic::decode")]
    field1: Gen<T>,
    #[n(1)]
    field2: U,
}
...
struct BS2<'a, T> {
    ...
    field1: Borrowed<'a>,
    #[b(1)]
    #[cbor(encode_with = "borrow::encode")]
    field2: &'a str,
    #[n(2)]
    field3: T,
}
...
struct BS3<'a, T> {
    ...
    field1: Borrowed<'a>,
    #[b(1)]
    #[cbor(decode_with = "borrow::decode")]
    field2: &'a str,
    #[n(2)]
    field3: T,
}
